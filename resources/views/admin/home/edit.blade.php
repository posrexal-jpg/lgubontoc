        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="{{ url('admin/home/edit/'.$getrecord->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="col-12">
                ...
                <div class="col-12">
                  <label class="form-label">Description <span style="color: red"> *</span></label>
                    <textarea class="form-control" name="description" value="{{$getrecord->description }}"></textarea>
                </div><hr>
                ...
                <div class="col-12" style="margin-top: 30px;" >
                  <button type="submit" class="btn bg-success text-white">Edit</button>
                  <a href="{{ url('admin/home') }}" class="btn bg-success text-white">Cancel</a>
